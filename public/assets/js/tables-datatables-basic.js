...
document.addEventListener("DOMContentLoaded", function(e) {
    {
        ...
        return setTimeout(() => {
            ...
            e && e.addEventListener("click", function() {
                offCanvasEl = new bootstrap.Offcanvas(a), a.querySelector(".dt-full-name").value = "", a.querySelector(".dt-post").value = "", a.querySelector(".dt-email").value = "", a.querySelector(".dt-date").value = "", a.querySelector(".dt-salary").value = "", offCanvasEl.show()
            })
        }, 200), fv = FormValidation.formValidation(a, {
            fields: {
                basicFullname: {
                    validators: {
                        notEmpty: {
