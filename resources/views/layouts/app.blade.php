...
>
  <!-- Mirrored from demos.themeselection.com/sneat-bootstrap-html-admin-template/html/horizontal-menu-template/dashboards-analytics.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 27 Mar 2022 09:26:51 GMT -->
  <head>
    <meta charset="utf-8" />
    <meta
      name="viewport"
    ...
    >
      <div class="layout-container">
        ...
        <nav
          ...
          id="layout-navbar" style="background: linear-gradient(to bottom right, #2EAF7D,#3FD0C9);"
        >
          <div class="container-xxl">
            <div class="navbar-brand app-brand demo d-none d-xl-flex py-0 me-4">
              <a href="{{ route('dashboard') }}" class="app-brand-link gap-2">
                <span class="app-brand-logo demo"> </span>
                <span class="app-brand-text demo menu-text text-white fw-bolder"
                  >Amazon Learn</span
                >
              </a>
            ...
            >
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item dropdown-language dropdown me-2 me-xl-0">
                  ...
                  >
                    <i
                      class="flag-icon flag-icon-us flag-icon-squared rounded-circle fs-3 me-1"
                    ></i>
                  </a>
                  <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                      ...
                      >
                        <i
                          class="flag-icon flag-icon-us flag-icon-squared rounded-circle fs-4 me-1"
                        ></i>
                    ...
                    <li>
                      ...
                      >
                        <i
                          class="flag-icon flag-icon-fr flag-icon-squared rounded-circle fs-4 me-1"
                        ></i>
                    ...
                    <li>
                      ...
                      >
                        <i
                          class="flag-icon flag-icon-de flag-icon-squared rounded-circle fs-4 me-1"
                        ></i>
                    ...
                    <li>
                      ...
                      >
                        <i
                          class="flag-icon flag-icon-pt flag-icon-squared rounded-circle fs-4 me-1"
                        ></i>
              ...
              <div class="container-xxl d-flex h-100">
                @if(Auth::user()->type == 'superuser')
                    <ul class="menu-inner">
                      ...
                      <li class="menu-item">
                        <a href="admin-billings.html" class="menu-link">
                          <i class="menu-icon tf-icons bx bx-file"></i>
                          <div data-i18n="Billings">Billings</div>
                        </a>
                      </li>
                      <li class="menu-item @if(request()->routeIs('pending-consultations')) active @elseif(request()->routeIs('consulted')) active @elseif(request()->routeIs('re-consultations')) active @endif">
                        <a href="{{ route('pending-consultations') }}" class="menu-link">
                          <i class="menu-icon tf-icons bx bx-search"></i>
                          <div data-i18n="For Consultation">For Consultation</div>
                        </a>
                      </li>

                      <li class="menu-item">
                        <a href="admin-packages.html" class="menu-link">
                          <i class="menu-icon tf-icons bx bx-package"></i>
                          <div data-i18n="Packages">Packages</div>
                        </a>
                      </li>
                      <li class="menu-item">
                        <a href="manage-slots.html" class="menu-link">
                          <i class="menu-icon tf-icons bx bx-box"></i>
                          <div data-i18n="Manage Slots">Manage Slots</div>
                        </a>
                      </li>
                      <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                          <!-- Tables -->
                          <li class="menu-item">
                            <a href="admin-students.html" class="menu-link">
                          ...
                          <li class="menu-item">
                            ...
                            <ul class="menu-sub">
                              <li class="menu-item">
                                <a href="admin-teachers.html" class="menu-link">
                                  <div data-i18n="Teacher List">Teacher List</div>
                                </a>
                              </li>
                              <li class="menu-item">
                                <a href="teacher-attendance.html" class="menu-link">
                          ...
                          <li class="menu-item">
                            <a href="admin-systemusers.html" class="menu-link">
  ...
  <!-- Mirrored from demos.themeselection.com/sneat-bootstrap-html-admin-template/html/horizontal-menu-template/dashboards-analytics.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 27 Mar 2022 09:27:28 GMT -->
</html>
